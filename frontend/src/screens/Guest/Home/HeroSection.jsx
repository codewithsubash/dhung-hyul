...
export const HeroSection = () => {
  ...
  return (
    <div className="bg-green-50 rounded-b-3xl">
      <section className="relative w-full h-[90vh] overflow-hidden flex items-center justify-center rounded-b-3xl text-center">
